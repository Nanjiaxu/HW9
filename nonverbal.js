...
function redraw() {
  ...
  if (jumping) {
	context.drawImage(images["armjump"], x + 40, y - 42 - breathAmt);
  } else {
	context.drawImage(images["arm"], x + 40, y - 42 - breathAmt);
  }
  
  if (jumping) {
	context.drawImage(images["leg"], x, y- 6);
  } else {
	context.drawImage(images["leg"], x, y);
  }
